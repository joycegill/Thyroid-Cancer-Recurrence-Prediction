...
The trends in Age were formally assessed using a one-way ANOVA. The conditions for this model are sufficiently satisfied to imply correlation, and are shown in the appendix.
```{r echo = F}
